...
from examples.depth_wan.transformer_depth import DepthAIDNs, DepthWanModel
...
def main():
    ...
    model_transformer = DepthWanModel(transformer_rgb, transformer_depth, aidns)
    ...
    while True:
        ...
        for step, batch in enumerate(dataloader):
            ...
            prompt_embed = pipe.encode_prompt(prompt)[
                "context"
