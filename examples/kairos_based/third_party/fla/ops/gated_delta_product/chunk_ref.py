...
from examples.kairos_based.third_party.fla.ops.delta_rule import chunk_delta_rule
from examples.kairos_based.third_party.fla.ops.gated_delta_rule import chunk_gated_delta_rule
