...
from examples.kairos_based.third_party.fla.utils import autotune_cache_kwargs, check_shared_mem, is_nvidia_hopper, use_cuda_graph

NUM_WARPS = [2, 4] if is_nvidia_hopper else [2, 4, 8, 16]

from examples.kairos_based.modules.utils import FLAGS_KAIROS_IS_METAX
