...
from examples.kairos_based.third_party.fla.modules import RMSNorm
from examples.kairos_based.third_party.fla.modules.feature_map import DPFPFeatureMap, HadamardFeatureMap, HedgehogFeatureMap, T2RFeatureMap
from examples.kairos_based.third_party.fla.ops.linear_attn import chunk_linear_attn, fused_chunk_linear_attn, fused_recurrent_linear_attn
