...
from examples.kairos_based.third_party.fla.layers.lightnet import LightNetAttention
...
from examples.kairos_based.third_party.fla.modules import GatedMLP as LightNetMLP
