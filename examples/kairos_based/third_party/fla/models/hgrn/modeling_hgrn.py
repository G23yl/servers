...
from examples.kairos_based.third_party.fla.layers.hgrn import HGRNAttention
...
from examples.kairos_based.third_party.fla.modules import GatedMLP as HGRNMLP
